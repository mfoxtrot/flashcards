...
describe Card do
  ...
  it "Saves new Card when all fields are correct" do
    new_card = Card.new(original_text: "Hi", translated_text: "Привет", review_date: "01.01.2014")
  ...
  it "Card is invalid when original_text is zero-length" do
    new_card = Card.new(original_text: "", translated_text: "abc", review_date: "01.01.2014")
    expect(new_card).not_to be_valid
  end

  it "Throw an error when translated_text is nil" do
    new_card = Card.new(original_text: "ABC", translated_text: nil, review_date: "01.01.2014")
    expect{new_card.save}.to raise_error
  end

  it "Card is invalid when translated_text is zero-length" do
    new_card = Card.new(original_text: "ABC", translated_text: "", review_date: "01.01.2014")
    expect(new_card).not_to be_valid
  end
